...
import "deploy/foundry/deployments/DeployOffchainOracleMode.s.sol";

contract OffchainOracleModeTest is Test {
    DeployOffchainOracleMode public deploy;
    OffchainOracle public offchainOracle;
    MultiWrapper public multiWrapper;
    IOracle[] public oracles;

    function setUp() public {
        vm.createSelectFork("mode", 18002652);
        deploy = new DeployOffchainOracleMode();
        deploy.setUp();
        deploy.run();
    ...
    function testGetRate() public view {
        ...
        IERC20 dstToken = IERC20(0xd988097fb8612cc24eeC14542bC03424c656005f); //mode

        uint256 weightedRate = offchainOracle.getRate({srcToken: srcToken, dstToken: dstToken, useWrappers: false});

        assertEq(weightedRate, 3639971125);
    }
}
